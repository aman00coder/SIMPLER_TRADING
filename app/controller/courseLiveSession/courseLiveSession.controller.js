// // controllers/liveSession/courseLiveSession.controller.js
// import { v4 as uuidv4 } from "uuid";
// import CourseLiveSession from "../../model/CourseLiveSession/CourseLiveSession.modal.js";
...
//   // Aapka frontend URL
//   return `${process.env.FRONTEND_URL || 'http://localhost:3000'}/live/${sessionId}?room=${roomCode}`;
// };

// // ✅ CREATE SESSION (Main Controller - Ek hi baar save karega dono jagah)
...
//     // Validation
//     if (!title || !courseId) {
//       return sendErrorResponse(res, "Title and Course ID are required", 400);
//     }
...
//     // Check if user can create session for this course
//     const isCourseCreator = course.createdBy.toString() === streamerId;
//     const isAdmin = userRole === ROLE_MAP.ADMIN;
    
//     // if (!isCourseCreator && !isAdmin) {
//     //   return sendErrorResponse(res, "You can only create sessions for your own courses", 403);
//     // }
...
//     const newLiveSession = new CourseLiveSession({
//       sessionId,
//       roomCode,
//       title,
...
//     // 🔹 STEP 2: Course mein bhi save karein (IMPORTANT)
//     const liveClassData = {
//       sessionId: sessionId, // Store the sessionId (not _id)
//       sessionTitle: title,
//       joinLink: joinLink, // YAHI LINK DONO JAGAH SAVE HOGI
//       roomCode: roomCode,
//       scheduleAt: new Date(),
//       duration: duration,
//       mentor: streamerId,
...
//       success: true,
//       message: "Live session created and linked to course",
//       data: {
//         session: newLiveSession,
//         courseLinked: true,
//         joinLink: joinLink // Yehi link frontend ko milega
//       }
...
// // controllers/liveSession/courseLiveSession.controller.js (continued)

// // ✅ JOIN PARTICIPANT (Existing logic copy)
...
//     // Find session
//     const liveSession = await CourseLiveSession.findOne({
//       $or: [
//         { sessionId: sessionId },
//         { roomCode: roomCode }
//       ]
...
//     if (liveSession.participantsCount >= liveSession.maxParticipants) {
...
//       courseId,
//       streamerId,
//       joinLink, // Added joinLink field as per updated model
//       duration,
//       maxParticipants,
//       status: "ACTIVE",
