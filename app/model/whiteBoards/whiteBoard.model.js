...
const whiteboardSchema = new mongoose.Schema(
  {
    ...
    participants: [
      {
        ...
        canErase: { type: Boolean, default: true },
    ...
    toolSettings: {
      ...
      shape: { type: String, default: "pen" },
      opacity: { type: Number, default: 1 }
    },
    selectedTool: { type: String, default: "pen" },
    layers: [
      {
        layerId: String,
        name: String,
    ...
    cursorHistory: [{ userId: mongoose.Schema.Types.ObjectId, position: mongoose.Schema.Types.Mixed, timestamp: Date }],
    ...
    versionTags: { type: [String], default: [] },
    ...
    replayData: { type: mongoose.Schema.Types.Mixed, default: {} },
    ...
    totalEdits: { type: Number, default: 0 },
    totalMessages: { type: Number, default: 0 },
    totalDrawActions: { type: Number, default: 0 },
    totalErases: { type: Number, default: 0 },
